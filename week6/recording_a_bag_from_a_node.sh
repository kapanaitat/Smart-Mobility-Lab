...
## writing C++ node, creating simple_bag_recorder.cpp inside ros2_ws/src/bag_recorder_nodes/src
...
# in a new terminal after navigating tos ros2_ws
...
## recroding a C++ node , creating data_generator_node.cpp inside ros2_ws/src/bag_recorder_nodes/src
...
## building and running in ros2_ws
colcon build --packages-select bag_recorder_nodes
...
# after 30 seconds terminate and play back
...
# inside the ros2_ws/src/bag_recorder_nodes/src , create data_generator_executable.cpp
#include <chrono>
