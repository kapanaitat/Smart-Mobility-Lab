...
## creating src/sync_async_writer.cpp file with this content
#include <chrono>
#include <functional>
#include <memory>
#include <string>
...
## adding executables in CMakeList.txt
...
## and then cleaniing up the file to make it look like this
...
## creating a node with subscribers
#include <functional>
#include <memory>
...
## adding SyncAsyncReader executable in CMakeList
...
# creating a scr/ping_client.cpp
#include <chrono>
#include <memory>
